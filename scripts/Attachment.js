...
(function (modules) {
    ...
    (function (attachment_1) {
        ...
        class Uploader {
            ...
            uploading = false;
            constructor($dom, attachment, properties) {
                this.$dom = $dom;
            ...
            getType(mime) {
                ...
                switch (type) {
                    case 'image':
                        ...
                        return 'image';
                    case 'application':
                        if (detail.search(/(pdf|officedocument|opendocument|word|powerpoint|excel|json|xml|rtf)/) > -1) {
                            return 'document';
                        }
            ...
            async #upload() {
                ...
                request.setRequestHeader('Content-Range', 'bytes ' + file.uploaded + '-' + (chunk - 1) + '/' + file.size);
